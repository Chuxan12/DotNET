    ...
    public static void Seed(ApplicationDbContext context)
    {
        ...
        var initial = new List<Anime>
        {
            new Anime {
                ...
                Description = "Человечество скрывается за гигантскими стенами, спасаясь от титанов-людоедов. Молодой солдат Эрен Йегер клянётся уничтожить их всех.",
            ...
            new Anime {
                ...
                Description = "Братья Элрик ищут Философский камень, чтобы вернуть потерянные тела, нарушив главный запрет алхимии.",
            ...
            new Anime {
                ...
                Description = "Старшеклассник Лайт Ягами находит тетрадь, способную убивать любого, чьё имя будет записано в ней.",
            ...
            new Anime {
                ...
                Description = "Юный пират Манки Д. Луффи отправляется за легендарным сокровищем «One Piece», чтобы стать королём пиратов.",
            ...
            new Anime {
                ...
                Description = "Тандзиро вступает в отряд истребителей демонов, чтобы спасти сестру, превращённую в демона.",
            ...
            new Anime {
                ...
                Description = "Мальчик Гон хочет стать Хантером, чтобы найти своего отца, одного из величайших охотников.",
            ...
            new Anime {
                ...
                Description = "Спустя два года Наруто возвращается в деревню, чтобы продолжить путь ниндзя и спасти друга.",
            ...
            new Anime {
                ...
                Description = "Итадори Юдзи поглощает проклятый палец демона Рёмена Судзу, чтобы спасти друзей, и вступает в мир магов-шаманистов.",
            ...
            new Anime {
                ...
                Description = "Супершпион «Сумрак» собирает фиктивную семью, не зная, что жена — убийца, а дочь — телепат.",
            ...
            new Anime {
                ...
                Description = "Безродный Денджи заключает контракт со своим питомцем-демоном Почитой и превращается в человека-бензопилу.",
            ...
            new Anime {
                ...
                Description = "Тридцатилетний неудачник перерождается в магическом мире, решив на этот раз прожить жизнь без сожалений.",
            ...
            new Anime {
                ...
                Description = "Двое старшеклассников из разных уголков Японии внезапно начинают менятьcя телами во сне и пытаются встретиться в реальности.",
            ...
            new Anime {
                ...
                Description = "10-летняя Тихиро попадает в мир духов и должна спасти родителей, превращённых в свиней.",
            ...
            new Anime {
                ...
                Studio      = "CoMix Wave Films",
                ImagePath   = "https://shikimori.one/uploads/poster/animes/38826/d9c3e31fccb2802c259b735c3a3655ef.jpeg",
                Description = "Беглый школьник встречает девушку-«солнечную деву», способную рассеивать дождь над Токио.",
        ...
        /* ------------► ДОБАВЛЯЕМ СПЕШЛЫ ◄------------ */
            ...
            new Anime {
                ...
                Studio      = "Wit Studio",
                ImagePath   = "https://shikimori.one/uploads/poster/animes/25781/649324642e35b46236a89a85e1f092d9.jpeg",
